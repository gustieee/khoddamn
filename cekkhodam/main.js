document.addEventListener('DOMContentLoaded', () => {
    ...
    const khodamList = [
        'Suprapto Ngebut', 'Badag Genjor', 'Laba-laba Sunda', 'Toren Aer', 'Elang Kuning' , 'Sabun gif' , 'Kartu Tri' , 'Ibnu betboi😈' , 'Joko Kendil'
    ];
    ...
    const teraawangKhodam = () => {
        ...
        nama1.textContent = `Nama: ${nama}`;
        khodam1.textContent = `Khodam: ${khodam}`;
    };
